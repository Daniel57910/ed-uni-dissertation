...
def parse_args():
    ...
    parse.add_argument('--part', type=str, default='train')
    parse.add_argument('--feature_extractor', type=str, default='cnn') 
    parse.add_argument('--q2', type=bool, default=False)
...
def main(args):
    ...
    sample_env = CitizenScienceEnvQ2(df_files[0], out_features, N_SEQUENCES)
    step = sample_env.reset()
    
    try:
        model.learn(total_timesteps=10_000, log_interval=10, progress_bar=True, callback=callback_list)
